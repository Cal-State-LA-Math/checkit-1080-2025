class Generator(BaseGenerator):
  def data(self):
        ...
        scenariotypes = ["age", "proj", "cost", "butterfly"]
        scenario = "butterfly"
        ...
        if scenario == "cost":
            ...
            tasks = [
                ...
                {"task_mincost": {"mincost":"{:.2f}".format(mincost)}}
            ]
            shuffle(tasks)
        ...
        if scenario == "butterfly":
            ...
            q(t) = a*t^2+b*t+c
            maxtime = round(-b/(2*a),2)
            maxheight = round(q(maxtime),2)

            tasks = [
                {"task_maxtime": {"maxtime": maxtime}},
                {"task_maxheight": {"maxheight": maxheight}},
            ]
            shuffle(tasks)
